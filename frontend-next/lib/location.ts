...
/** Remove old Hyderabad fallback saved when GPS was denied. */
...
/** Fresh GPS fix — do not reuse a cached position from another city. */
...
/**
 * Resolve location for a scan:
 * 1) Manual city selection always wins
 * 2) Fresh GPS on every scan
 * 3) Last known GPS only if fresh GPS fails
 */
